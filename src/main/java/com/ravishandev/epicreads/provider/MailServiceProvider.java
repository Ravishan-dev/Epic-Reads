...
public class MailServiceProvider {
    ...
    private MailServiceProvider(){
        ...
        properties.put("mail.amtp.startless.enable", true);
    ...
    public void sendMail(Mailable mailable){
        ...
        if(executer != null && !executer.isShutdown()){
            executer.execute(mailable);
        }else{
            throw new IllegalStateException("Mail Service Provide is not Initialized");
        }
    }
